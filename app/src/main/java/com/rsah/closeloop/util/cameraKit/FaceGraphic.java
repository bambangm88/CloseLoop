...
class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    public void draw(Canvas canvas) {
        ...
        if (!INFRAN_NAME.equals("")){
            canvas.drawText("Found: " + INFRAN_NAME, x + ID_X_OFFSET, y + ID_Y_OFFSET, mIdPaint);
        }
       ...
       // canvas.drawText("Jangan Bergerak  ",x-ID_X_OFFSET,y-ID_Y_OFFSET+3*ID_TEXT_SIZE,mIdPaint);
        ...
        if (!INFRAN_Message.equals("")){
            canvas.drawText(INFRAN_Message, x + ID_X_OFFSET, y + ID_Y_OFFSET, mIdPaint);
        }
